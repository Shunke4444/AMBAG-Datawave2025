...
async def get_goal_baseline(goal_id: str) -> Optional[Dict]:
    ...
    return {
        ...
        "current_amount": pool_data["current_amount"] if pool_data and "current_amount" in pool_data else 0,
        "target_date": goal['target_date'].isoformat(),
        "status": goal['status'],
        "contributors": pool_data["contributors"] if pool_data and "contributors" in pool_data else [],
